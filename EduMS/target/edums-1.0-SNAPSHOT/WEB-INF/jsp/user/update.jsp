...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 15px">
        ...
        <form class="layui-form" style="width: 600px" action="${baseUri}/user/update/${user.ID}" method="post"
            ...
            <div class="layui-form-item">
                ...
                <img src="${baseUri}${sessionScope.imgPath}/${user.avatar}" alt="头像" width="64px" height="64px;">
            </div>
