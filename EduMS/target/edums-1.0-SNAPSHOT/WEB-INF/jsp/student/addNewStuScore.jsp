...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 15px">
        ...
        <form class="layui-form" action="${baseUri}/student/addNewStuScore" method="POST"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 400px;">
                    <input type="text" name="term" lay-verify="required"
                           autocomplete="off" placeholder="请输入学期" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="chinese" lay-verify="required"
                           autocomplete="off" placeholder="请输入语文成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="math" lay-verify="required"
                           autocomplete="off" placeholder="请输入数学成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="english" lay-verify="required"
                           autocomplete="off" placeholder="请输入英语成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="physical" lay-verify="required"
                           autocomplete="off" placeholder="请输入物理成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="chemical" lay-verify="required"
                           autocomplete="off" placeholder="请输入化学成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="biology" lay-verify="required"
                           autocomplete="off" placeholder="请输入生物成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="history" lay-verify="required"
                           autocomplete="off" placeholder="请输入历史成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="policy" lay-verify="required"
                           autocomplete="off" placeholder="请输入政治成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="geography" lay-verify="required"
                           autocomplete="off" placeholder="请输入地理成绩" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 150px;">
                    <input type="text" name="gym" lay-verify="required"
                           autocomplete="off" placeholder="请输入体育成绩" class="layui-input">
                </div>
            </div>
